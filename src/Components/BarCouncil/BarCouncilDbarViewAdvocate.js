...
function BarCouncilDbarViewAdvocate() {
  ...
  return (
    <div>
        {
            advocates.length>0?<div className="d-flex justify-content-center mt-5">
        <div className="col">
                      ...
                      <div className="col-sm-3 ">
                        ...
                        >
                          ...
                          <div class="card-body">
                            <p className="text-center">
                              <Link
                                to={`/BarCouncil_view_details/${advocates._id}/debar`}
      ...
      </div>:<div className="no_data_animation">
