                                ...
                                data.map((advocate) => (
                                    <tr key={advocate._id}>
                                        ...
                                        <td className="table-data">
                                            <button className="btn btn-success" onClick={() => handleActivate(advocate._id, advocate.advId._id)}>
                                                Cancel Debar
                                            </button>
                                            {
                                                advocate.status=='Reviewed'?'':<button className="btn btn-primary mx-2" onClick={() => handleReply(advocate._id)}>
                                                Reply
                                            </button>
                                            }
